...
abstract class AppColor {
  ...
  static const Color backgroundIcon = Color(0xFFDAD6D6);
  static const Color iconColor = Color(0xFF7EB5E3);
  static const Color backgroundHomeProduct = Color(0x47000000);
  static const Color backgroundScaffoldLight = Color(0xFFFFFFFF);
  static const Color backgroundScaffoldDark = Color(0xFF121212);
  static const Color cardLight = Color(0xFFFFFFFF);
  static const Color cardDark = Color(0xFF1E1E1E);
  static const Color favorite = Color(0xFFE62517);
  static const Color price = Color(0xFF01A70C);
  static const Color star = Color(0xFFFFC107);
  static const Color snackbarLight = Color(0xAAFFFFFF);
  static const Color snackbarDark = Color(0xCC1E1E1E);
  ...
  // static const Color iconDelete = Color(0xFFFFFFFF);
  // static const Color dropDown = Color(0x1F000000);
  // // static const Color titleSpalsh = Color(0xFF448AFF);
}
...
abstract class AppColorText {
  ...
  static const Color textButtonDark = Color(0xFFDDDDDD);
