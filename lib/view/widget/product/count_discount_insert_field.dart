...
class CountDiscountInsertField extends GetView<InsertProductControllerImp> {
  const CountDiscountInsertField({super.key});
      ...
      children: [
        ...
        Expanded(
          child: CustomTextFormFieldWidget(
            ...
            keyboardType: TextInputType.number,
            validator: (value) => validatorDigitalWithNull(value),
          ),
        ),
      ],
    );
