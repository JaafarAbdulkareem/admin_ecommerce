...
class BodyDeliveryMessageView extends GetView<DeliveryMessageControllerImp> {
  const BodyDeliveryMessageView({super.key});
          ...
          child: Column(
            ...
            children: [
              TitleDescriptionWidget(
                ...
                subTitle: KeyLanguage.messageDeliveryMessage.tr,
              ),
