...
import 'package:admin_ecommerce/data/data_source/remote/message/users_message_remote.dart';
...
class UsersMessageControllerImp extends UsersMessageController {
  ...
  late UsersMessageRemote _messageRemote;
  ...
  void onInit() {
    ...
    _messageRemote = UsersMessageRemote(curd: Get.find());
